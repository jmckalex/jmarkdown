...
Extension tuples:  /\(\s*x([0-9a-z])\s*,\s*y([0-9a-z])\s*,\s*z([0-9a-z])\)/	/\(\s*x([0-9a-z])\s*,\s*y([0-9a-z])\s*,\s*z([0-9a-z])\)/	false 3
...
And what about the special command used at the start of this page, which
